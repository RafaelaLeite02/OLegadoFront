<template>
  <div>
    ...
    <section @click="abrirModal" class="w-160 flex flex-col items-center text-center p-5 pt-15">
      <button
        class="text-neutral-300 border-0 bg-gradient-to-r from-stone-950 via-gray-900 to-stone-950 text-[25px]
               hover:text-[28px] hover:text-red-700 hover:font-weight:900 transition-transform delay-200
