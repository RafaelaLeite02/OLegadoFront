<template>
    <div
        class="fixed inset-0 z-[9999] flex items-center justify-center bg-gradient-to-b from-stone-950  via-red-950 to-stone-950 bg-opacity-75 ">
        <div
            class="w-full max-w-5xl overflow-y-auto max-h-[90vh] rounded-xl bg-gradient-to-b from-stone-950 via-red-950 to-stone-950 bg-opacity-75 shadow-2xl">
            <div class="relative p-8">
                ...
                <div class="flex flex-col items-center p-6 text-center">
                    <div class="relative mb-6">
                        <img class="h-64 w-64 rounded-full border-4 border-red-700 object-cover shadow-lg"
                            :src="personagem.fotoURL" :alt="personagem.name" />
                        <div
                            class="absolute bottom-2 right-2 flex items-center gap-1 rounded-full bg-red-700 px-3 py-1 text-xs font-semibold text-white">
                        ...
                        <div v-if="personagem.habilidades.length > 0">
                            ...
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                <div class="flex items-center gap-3 rounded-lg bg-gray-800 p-3"
                                    v-for="habilidade in habilidadesListadas" :key="habilidade">
                        ...
                        <div v-if="personagem.personalidade.length > 0">
                            ...
                            <ul class="space-y-3">
                                <li class="flex items-center gap-2 text-gray-300"
                                    v-for="caracteristica in personalidadesListadas" :key="caracteristica">
                            ...
                            <div class="flex flex-col items-center">
                                ...
                                <div class="mt-4 h-2 w-full rounded-full bg-gray-800">
                                    <div class="h-2 rounded-full bg-red-600"
                                        :style="{ width: (personagem.nivelPoder * 10) + '%' }"></div>
                                </div>
                            </div>
                        </div>
                    </div>
